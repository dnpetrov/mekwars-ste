 ...
 */
public class oldTimeUpdatePlanet extends oldPLanet {

    public oldTimeUpdatePlanet(int id, String name, Position position, Influences flu) {
        super(id, name, position, flu);
    }

    public oldTimeUpdatePlanet() {
        super();
    }
